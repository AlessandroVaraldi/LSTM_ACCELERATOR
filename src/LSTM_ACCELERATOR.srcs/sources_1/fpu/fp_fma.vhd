...
begin
	...
	begin
		...
		exponent_mul := signed("00" & exponent_a) + signed("00" & exponent_b) - 255;
		...
		mantissa_add := "000" & mantissa_c & "00" & X"000000000000";
		mantissa_mul := "00" & std_logic_vector(unsigned(mantissa_a) * unsigned(mantissa_b)) & "000" & X"000000";
