...
synth_design -top LSTM_ACCELERATOR -part xc7k70tfbv676-1
...
write_checkpoint -force -noxdef LSTM_ACCELERATOR.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file LSTM_ACCELERATOR_utilization_synth.rpt -pb LSTM_ACCELERATOR_utilization_synth.pb"  } 
